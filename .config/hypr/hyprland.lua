...
hl.config({
    general = {
        ...
        layout = "dwindle",
        col = {
            active_border = { colors = { "rgba(c74a4aee)", "rgba(c74a4acc)" }, angle = 45 },
            inactive_border = "rgba(c74a4a88)",
        },
    },
})
...
-- 让 satty 强制以浮动窗口模式打开，不作为 Layer Shell

--windowrule = float, ^(com.gabm.satty)$

-- 确保它打开时居中

--windowrule = center, ^(com.gabm.satty)$
